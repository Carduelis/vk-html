...
ex10 : {
	nameOfExercise : 'Дистанционное включение ГРМ',
	el1 : {
		click : '1',
		current : {
			inStack : 'stack9',
			inBlock : 'stack9_block1',
			onSide : 'stack9_block1_front',
			num : '134',
			type : 'toggler',
		},
		positions : {
	...
	el2 : {
		...
		positions : {
			position_1 : {
				state : '0',
				description : 'Выберите первый комплект ГРМ',
				action_1 : {
					inStack : 'stack9',
					inBlock : 'stack9_block1',
					onSide : 'stack9_block1_front',
